...
> Griffan hat sich über die letzten Jahrzehnte immer weiter der Küste genähert und ist eine der Getreide Produktionen des Reiches.
...
> ```
## Demographics
### Random NPC: `dice: [[ThisFile#^Spezies]]` / `dice: [[ThisFile#^Beruf]]`
### Table Betriebe
